...
export const article = {
  author: 'Adam Wathan',
  date: '2024-09-05',
  title: 'Conceitos de mulheres sobre sua menstruação',
  description:'Dando prosseguimento às pesquisas anteriores realizadas pelo Núcleo de de Assistência para o Autocuidado da Mulher (NAAM) sobre aspectos relativos à menstruação,',
}
