      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            <MobileNavItem href="/about">Sobre nós</MobileNavItem>
            <MobileNavItem href="/articles">Artigos</MobileNavItem>
            <MobileNavItem href="/projects">Notícias</MobileNavItem>
            <MobileNavItem href="/speaking">Campanhas</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-[2px] bg-linear-to-r from-pink-500/0 via-pink-500/40 to-pink-500/0 dark:from-pink-400/0 dark:via-pink-400/40 dark:to-pink-400/0" />
        )}
      </Link>
    </li>
  )
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/about">Projeto</NavItem>
        <NavItem href="/articles">Artigos</NavItem>
        <NavItem href="/projects">Notícias</NavItem>
        <NavItem href="/speaking">Campanhas</NavItem>
      </ul>
    </nav>
  )
}
...
function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media_not_(prefers-color-scheme:dark)]:fill-pink-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-pink-500 [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400" />
    </button>
  )
}
...
function AvatarContainer({
  ...
  return (
    <div
      className={clsx(
        className,
        'h-12 w-12 rounded-full bg-white/90 p-0.5 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:ring-white/10',
      )}
      {...props}
    />
  )
